  ...
  useEffect(() => {
    if (!orderSaved && orderData && orderData.items.length > 0) {
      ...
      const newOrder = {
        ...
        // Billing Address (same as shipping in this case)
        billingAddress: {
          name: 'Priya Sharma',
          phone: '+91 98765 43210',
          email: 'priya.sharma@example.com',
            ...
            <CardContent className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <div className="p-4 rounded-lg bg-muted/50 border">
                  ...
                  <div className="flex items-center justify-between">
                    <p className="font-mono font-bold text-sm md:text-base">{trackingId}</p>
                    <Button
                      variant="ghost"
                      size="sm"
              ...
              <div className="p-4 rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-lg font-bold text-blue-700">{getEstimatedDelivery()}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-1">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="font-semibold text-lg">Live Tracking Status</h3>
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center gap-3">
                <div className="p-2 rounded-lg bg-gradient-to-br" style={{ background: assignedCourier.gradient }}>
                  <Truck className="size-6 text-white" />
                </div>
                <div>
                  <p className="font-semibold">{assignedCourier.name}</p>
                  <p className="text-xs text-muted-foreground">{assignedCourier.description}</p>
                </div>
              </div>
              ...
              <div className="space-y-3 pt-3 border-t">
                ...
                <div className="flex items-center gap-2 text-sm">
                  ...
                  <span className="text-xs">{assignedCourier.email}</span>
                </div>
              </div>
          ...
          <Card className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
            ...
            <CardContent className="space-y-3">
              <p className="text-sm text-gray-700 leading-relaxed">
                No login required! Track your order anytime using your Order Number and Phone Number.
              </p>
              
              <div className="p-3 rounded-lg bg-white/70 border border-green-200/50">
                <p className="text-xs font-semibold text-gray-900 mb-2">Your Order Number:</p>
                <div className="flex items-center justify-between mb-3">
                  <p className="font-mono font-bold text-sm text-green-700">{orderNumber}</p>
                  <Button
                    variant="ghost"
                    size="sm"
                    onClick={() => copyToClipboard(orderNumber)}
              ...
              <Button 
                ...
                onClick={() => {
                  const url = window.location.origin + '/track-order';
                  navigator.clipboard.writeText(url);
                  alert('Tracking page link copied! Share or bookmark this link.');
                }}
              >
              ...
              <div className="pt-3 border-t border-green-200/50">
                <p className="text-xs text-gray-600 text-center">
                  📱 Bookmark this page or save your order number
                </p>
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-amber-50 to-yellow-50 border-amber-200">
            ...
            <CardContent className="space-y-4">
              {/* Delivery Address */}
              <div>
                <p className="font-semibold text-sm mb-2 text-gray-900">Shipping Address</p>
                <div className="p-3 rounded-lg bg-white/70 border border-amber-200/50 space-y-1">
                  <p className="font-semibold text-gray-900">Priya Sharma</p>
                  <p className="text-sm text-gray-700">123, MG Road, Apartment 4B</p>
                  <p className="text-sm text-gray-700">Koramangala, Bangalore</p>
                  <p className="text-sm text-gray-700">Karnataka - 560034</p>
                  <div className="pt-2 mt-2 border-t border-amber-200/50 flex items-center gap-4">
                    <div className="flex items-center gap-1.5">
                      <Phone className="size-3.5 text-amber-600" />
                      <p className="text-xs font-medium text-gray-700">+91 98765 43210</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {/* Delivery Time Slot */}
              <div>
                <p className="font-semibold text-sm mb-2 text-gray-900">Expected Delivery Window</p>
                <div className="p-3 rounded-lg bg-white/70 border border-amber-200/50">
                  <div className="flex items-center gap-2 mb-2">
                    <Clock className="size-4 text-amber-600" />
                    <p className="font-semibold text-gray-900">9:00 AM - 8:00 PM</p>
                  </div>
                  <p className="text-xs text-gray-600 leading-relaxed">
                    Our delivery partner will attempt delivery during business hours. Please ensure someone is available to receive the package.
                  </p>
                </div>
              </div>
              ...
              <div>
                <p className="font-semibold text-sm mb-2 text-gray-900">Special Instructions</p>
                <div className="p-3 rounded-lg bg-white/70 border border-amber-200/50">
                  <p className="text-xs text-gray-600 leading-relaxed">
                    📦 Please call before delivery<br />
                    🏠 Leave with security if not available
                  </p>
                </div>
              </div>
              ...
              <div className="p-3 rounded-lg bg-gradient-to-br from-amber-100 to-yellow-100 border border-amber-300">
                <p className="text-xs font-semibold text-amber-900 mb-1">💡 Quick Tip</p>
                <p className="text-xs text-amber-800 leading-relaxed">
                  Keep your phone handy! Our delivery partner will call you when nearby.
                </p>
              </div>
            </CardContent>
          </Card>
